...
const img = (seed: string) =>
  `https://images.unsplash.com/photo-${seed}?w=800&q=70&auto=format&fit=crop`;

export const HALLS: Hall[] = [
  {
    id: "h1",
    name: "K.B.Dhasan Salai Community Center",
    rating: 4.4,
  ...
  {
    id: "h2",
    name: "Model School Road Community Center",
    rating: 4.4,
    ...
    halfDayRent: 4000,
    deposit: 15000,
    halfDayDeposit: 15000,
    zone: "9",
    division: "110",
    landmark: "Opp. Panagal Park",
    capacity: 800,
  ...
  {
    id: "h3",
    name: "MMDA colony Community Center",
    rating: 4.4,
  ...
  {
    id: "h4",
    name: "KK Nagar Community Center",
    rating: 4.4,
